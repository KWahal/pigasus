...
original_texts = "".join(open('gform_for_paraphrase.txt', 'r').readlines())
original_texts = original_texts.split(SEPARATOR)[1:]

# original_texts_new = []
# for text in original_texts:
#   text = text.split(SEPARATOR2)[1:]
#   print(text)
#   for section in text:
#     original_texts_new.append(section)
...
for text in tqdm(original_texts):
  ...
  paraphrases = ' '.join(paraphrased)
  all_paraphrased.append(paraphrases)
