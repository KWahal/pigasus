...
summary = pd.DataFrame({"Pigasus OUR PRETRAIN, FINETUNED 100 LONG CA_VAL R1": list(r1), 
                        "Pigasus OUR PRETRAIN, FINETUNED 100 LONG CA_VAL R2": list(r2), 
                        "Pigasus OUR PRETRAIN, FINETUNED 100 LNOG CA_VAL RL": list(rl)},
