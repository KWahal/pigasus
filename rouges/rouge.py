...
- caval_finetunedCA.csv => pegasus large finetuned on CA test (uses [865:1051])
'''

path_to_summs = "./summaries/val_ca_sum_10_100_REAL2.txt"
path_to_summs = "/Users/karsenwahal/Desktop/pigasus/summaries/peglarge_CA_VALID_summs.txt"
...
with open('./caval_peglarge.csv', 'w') as csvfile:
